...
## Convenience scripts
- Backend + DB: `./scripts/dev-backend.sh` (starts docker-compose Postgres, then runs Spring Boot)
- Frontend dev: `./scripts/dev-frontend.sh` (npm install + Vite dev server on :5173)
